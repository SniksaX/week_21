...
## Description
Cette API permet à un utilisateur de gérer ses comptes bancaires et ses transactions.  
...
## Configuration
- Le serveur écoute sur le port défini dans le fichier `.env` (par défaut `8080`).
